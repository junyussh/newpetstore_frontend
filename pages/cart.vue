<template>
    <section class="section">
        <b-field grouped group-multiline>
            <div class="control">
                <b-switch v-model="position" true-value="is-right"
                    >Right position</b-switch
                >
            </div>
        ...
        >
            ...
            <b-step-item label="Complete" icon="account-plus" disabled>
                ...
                onConfirm: value => {
                    if (value == "crf") {
                        ...
                        this.cart.forEach(item => {
                            ...
                            this.form.quantity = item.amount;
                            this.$axios
                                .$post("/orders/", _this.form)
                                .then(res => {
                                    if (res.id) {
                                        _this.clearForm();
                                        this.success("Order Complete");
                                        this.clearCart();
                                    }
                                })
                                .catch(e => {
